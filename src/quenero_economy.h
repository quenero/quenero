...
constexpr uint64_t COIN                       = (uint64_t)1000000000; // 1 QUENERO = pow(10, 9)
...
// TODO: For now we add 1 extra atomic quenero to the HF16 block reward, above; ultimately with pulse
