...
if len(sys.argv) < 3:
    ...
    if m:
        ...
        r = requests.post(quenerorpc, json={"jsonrpc":"2.0", "id":0, "method":"get_service_node_privkey"}).json()
...
if direct:
    ...
    r = requests.post(quenerorpc, json={"jsonrpc":"2.0", "id":0, "method":"get_service_nodes", "params": {
